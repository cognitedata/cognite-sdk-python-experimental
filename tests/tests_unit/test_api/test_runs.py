...
class TestIntegrations:
    ...
    def test_create_single(self, mock_create_run_response):
        res = TEST_API.create(IntegrationRun(external_id="py test id", status="success"))
    ...
    def test_create_multiple(self, mock_create_run_response):
        run1 = IntegrationRun(external_id="py test id", status="success")
        run2 = IntegrationRun(external_id="py test id", status="seen")
